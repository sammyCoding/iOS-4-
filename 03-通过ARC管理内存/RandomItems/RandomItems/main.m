...
//        }
        ...
        ZWAItem *backpack = [[ZWAItem alloc]initWithItemName:@"Backpack"];
        [items addObject:backpack];
        
        ZWAItem *caculator = [[ZWAItem alloc]initWithItemName:@"Calculator"];
        [items addObject:caculator];
        backpack.containedItem = caculator;
