...
NSString * const ZWANextItemValuePrefsKey = @"NextItemValue";
NSString * const ZWANextItemNamePrefsKey = @"NextItemName";
...
+ (void)initialize {
    ...
    NSDictionary *factorySettings = @{ZWANextItemValuePrefsKey : @75, ZWANextItemNamePrefsKey : @"Coffee Cup"};
